#!/usr/bin/env python3
"""
Automatic duplicate cleanup script for NEUROMANCER vault.
Uses SBP pair analysis to identify and remove duplicate files automatically.
"""
...
def main():
    """Main function."""
    print("🔍 NEUROMANCER Automatic Duplicate Cleanup Tool")
    print("=" * 50)
    ...
    print(f"\n🗑️  Proceeding with deletion of {dry_run_count} duplicate files...")
